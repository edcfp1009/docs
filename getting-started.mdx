...
> **"Using FreightPOP, list my last 5 shipments."**

A successful response returns a short list of your recent shipments with their status. If you see an authentication error or nothing happens, jump to [Troubleshooting](/troubleshooting).
